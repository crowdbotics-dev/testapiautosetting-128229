...
## Project Structure
    ...
    ├── testapiautosetting_128229  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_128229`
...
2. Clone this repo and `cd testapiautosetting_128229`
